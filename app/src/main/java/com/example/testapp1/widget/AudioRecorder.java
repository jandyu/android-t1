package com.example.testapp1.widget;
...
import com.example.testapp1.util.MediaUtil;

public class AudioRecorder extends LinearLayout implements MediaRecorder.OnErrorListener,
        MediaRecorder.OnInfoListener, CompoundButton.OnCheckedChangeListener {
